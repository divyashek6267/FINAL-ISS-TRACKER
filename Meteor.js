...
import {Alert, Text,View,FlatList,SafeAreaView, StyleSheet, Platform, ImageBackground, Image,Dimensions } from 'react-native';
...
export default class MeteorScreen extends Component {
    ...
    getMeteors=()=>{
        axios
            .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=zZX6AmcuGDu1iGJwbKbissAHIcv26HdXeFAWezYM")
            .then(response =>{
